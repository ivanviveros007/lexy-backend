...
(
  'palabras_gemelas', 1,
  '¿Son iguales?', 'Discrimina b/d y p/q', 1, 60, 60,
  '{
    ...
    "pares": [
      ...
      { "palabraA": "pato",  "palabraB": "dato",  "sonGemelas": false }
    ]
  }'
);
...
(
  'intruso_rimas', 1,
  '¡Busca al intruso!', 'Dos riman, una no', 1, 70, 90,
  '{
    "tipo": "intruso_rimas",
    "minAciertos": 3,
    "grupos": [
      { "palabras": ["gato",  "pato",  "rato"],  "intruso": "pino"  },
      { "palabras": ["sol",   "col",   "rol"],   "intruso": "flor"  },
      { "palabras": ["pan",   "can",   "tan"],   "intruso": "mar"   }
    ]
  }'
);
...
(
  'conductor_texto', 1,
  'El jardín de Lexy', 'Texto corto, 2 preguntas', 1, 100, 120,
  '{
    "tipo": "conductor_texto",
    "minAciertos": 2,
    "texto": "Lexy tiene un jardín muy bonito. Hay rosas rojas y margaritas blancas. Cada mañana, Lexy riega las flores con una regadera azul.",
    "preguntas": [
      {
        "pregunta": "¿De qué color son las rosas?",
        "opciones": ["rojas", "blancas", "azules"],
        "respuestaCorrecta": "rojas"
      },
      {
        "pregunta": "Lexy riega las flores con una regadera ___",
